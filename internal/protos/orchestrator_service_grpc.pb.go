...
func (c *taskHubSidecarServiceClient) RestartInstance(ctx context.Context, in *RestartInstanceRequest, opts ...grpc.CallOption) (*RestartInstanceResponse, error) {
	...
	err := c.cc.Invoke(ctx, TaskHubSidecarService_RestartInstance_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *taskHubSidecarServiceClient) SkipGracefulOrchestrationTerminations(ctx context.Context, in *SkipGracefulOrchestrationTerminationsRequest, opts ...grpc.CallOption) (*SkipGracefulOrchestrationTerminationsResponse, error) {
	...
	err := c.cc.Invoke(ctx, TaskHubSidecarService_SkipGracefulOrchestrationTerminations_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedTaskHubSidecarServiceServer) SkipGracefulOrchestrationTerminations(context.Context, *SkipGracefulOrchestrationTerminationsRequest) (*SkipGracefulOrchestrationTerminationsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SkipGracefulOrchestrationTerminations not implemented")
}
